...
Route::post('verify', [ResultsController::class, 'verify']);
Route::get('result/list', [ResultsController::class, 'list']);
Route::get('test-blubear', [ResultsController::class, 'index']);
